...
<body>
    ...
    <section>
        <?php foreach ($news as $article) { ?>
            <article>
                ...
                <p>
                <form action="/homework6/adminPanel/editing/" method="get">
                    <input type="hidden" name="id" value="<?php echo $article->id; ?>">
                    <input type="submit" value="Изменить">
                </form>
                </p>
                <p>
                <form action="/homework6/adminPanel/delete/" method="get">
                    <input type="hidden" name="id" value="<?php echo $article->id; ?>">
    ...
    <section>
        <p>
            <form action="/homework6/adminPanel/save/" method="post">
