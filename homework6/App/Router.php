...
class Router
{
    ...
    {
        $uriPath = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH); //получаю только путь. /homework6/admin/index/action
    ...
    protected function getPartsUriPath()
    {
        ...
        $parts = explode('/', $this->uriPath); //разбиваю. ['', 'homework6', 'admin', 'index', 'action']
        ...
        unset($parts[0], $parts[1]); //удаляю '' и 'homework6'. ['admin', 'index', 'action']
