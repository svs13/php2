...
class Router
{
    ...
    {
        $uriPath = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH); //получаю только путь. /homework4/admin/index/action
    ...
    protected function getPartsUriPath()
    {
        ...
        $parts = explode('/', $this->uriPath); //разбиваю. ['', 'homework4', 'admin', 'index', 'action']
        ...
        unset($parts[0], $parts[1]); //удаляю '' и 'homework4'. ['admin', 'index', 'action']
